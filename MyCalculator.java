...
public class MyCalculator extends Frame
{
    ...
    final int FRAME_WIDTH=750,FRAME_HEIGHT=750;
    final int HEIGHT=75, WIDTH=75, H_SPACE=30,V_SPACE=15;
    final int TOPX=40, TOPY=60;
    ...
    MyCalculator(String frameText)
    {
        ...
        displayLabel.setBounds(tempX,y,630,HEIGHT);
    ...
    {
        new MyCalculator("Calculator - Panther Zero");
    }
}
